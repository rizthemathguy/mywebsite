...
/* Text Container */
.text-container {
    margin-right: 30px; /* Adjust space between text and image */
}
...
.about-me .text-container {
    max-width: 600px;
    text-align: left;
    margin-left: 40px; /* Increase space between image and text */
}
...
body.dark-mode .navbar, body.dark-mode .header-section, body.dark-mode .about-me, body.dark-mode .projects, body.dark-mode .photography {
...
#dark-mode-toggle {
    position: fixed;
    bottom: 20px; /* Moved to bottom left */
    left: 20px;
